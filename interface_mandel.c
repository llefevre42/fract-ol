...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/29 08:12:27 by llefevre          #+#    #+#             */
/*   Updated: 2017/08/29 08:28:36 by llefevre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	last_marge_m(t_tri *lst)
{
	...
	mlx_string_put(lst->mlx, lst->win2, 95, 670, 0X00FF00, "Iter 10");
...
{
	lst->win2 = mlx_new_window(lst->mlx, 500, 1000, "mandelbrot");
	lst->color = 0XF39C12;
	lst->t1 = 500;
	lst->t2 = 15;
	put_cub_bis(0, 0, lst);
	...
	mlx_string_put(lst->mlx, lst->win2, 195, 60, 0XFF0000, "MANDELBROT");
	suite_marge_m(lst);
	next_marge_m(lst);
	last_marge_m(lst);
}
